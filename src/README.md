...
The purpose of this project is to automate and streamline account reconciliation. Converting this to an electronic process will reduce manual effort associated with importing and manipulating data via pivot tables, eliminate the effort spent searching for and amending backup, and allow the Accounting team the ability to meet the growing account reconciliation demand
